...
\section{Nucleophilic Substitution}
  ...
  \begin{core}{\snt}
    ...
    \snt reactions are \textbf{bimolecular}, meaning that both the leaving group and nucleophile are present in the transition state and making the reaction rate dependent on both [Nu] and [E-L]. The following is a chemical reaction of \ce{CH3Cl} undergoing \snt reaction with \ce{OH-}.
...
\end{enumerate}
  ...
  \begin{core}{Steric Effects on Nucleophilic and Leavin Group Ability}
    
    \textbf{Steric effects} must be considered for both the nucleophile and leaving group. Steric effects arise from \ce{e^-} \ce{e^-} repulsion between the nucleophile or leaving group and the three substituents bonded to the target electrophile.
...
\end{enumerate}
    ...
    Here, the overall reaction rate is identical across all paths, as it depends solely on the departure of the leaving group (\textit{regardless of the nucleophile identity}). Because acetone is a aprotic solvent, the \ce{Cl-} product will be favored under a mixture of \ce{Cl-} and \ce{I-} because \ce{Cl-} is a stronger nucleophile than \ce{I-} is.
...
\end{enumerate}
    ...
    Generally speaking, rather than memorizing each of these scenarios and their cooresponding dominant mechanism, it's helpful to start with \snt as a starting point and ask yourself the following questions.
...
\end{enumerate}
    ...
    However, keep in mind that there are other nuancial factors to consider such as absence of E1 preference for weakly basic, good nucleophile conditions.

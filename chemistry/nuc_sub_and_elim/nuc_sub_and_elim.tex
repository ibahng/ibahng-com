...
\section{Nucleophilic Substitution}
  ...
  \begin{core}{\sno}
    ...
    \begin{enumerate}
      ...
      }{Relative \sno reaction rates in polar solvents}{fig:filler11}{1.0}      
      ...
      }{\sno nucleophile competition; \textit{Cl is a better nucleophile than I, thus a mixture will result in the Cl product (bottom reaction)}}{fig:filler12}{1.0}
...
\section{Elimination}
  ...
  \begin{core}{Elimination 1 (E1)}
    ...
    \myfig{0.9}{nuc_sub_and_elim_figures/e1_deprotonation}{E1 deprotonation}{fig:e1depro} % KEEP
    ...
    }{filler caption}{fig:filler14}{0.9}
  ...
  \begin{core}{Elimination 2 (E2)}
    ...
    \myfig{0.9}{nuc_sub_and_elim_figures/e2_ts}{E2 transition state}{fig:e2ts} % KEEP
    ...
    }{E2 hydrogen acidity amplification}{fig:filler15}{1.0}
    ...
    }{Stereospecific E2 outcomes; \textit{RR (top left), SS (top right), SR (bottom left), RS (bottom right)}}{fig:filler16}{0.9}
    ...
    }{Anti and syn-periplaner E2 reaction rates}{fig:filler18}{1.0}

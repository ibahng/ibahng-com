...
\section{Alkanes, Alkenes, and Alkynes}
...
\section{Alcohol}
  ...
  \begin{core}{Alcohol IUPAC Example}
    ...
    \myfig{0.6}{nomenclature_figures/alc_nomenclature}{Alcohol Nomenclature Examples}{fig:alc_nomenclature}
  ...
  \begin{core}{Cycloalkanols}
    ...
    \myfig{0.6}{nomenclature_figures/cycloalkanes2}{Cycloalkanol Nomenclature Examples}{fig:cycloalkanol_nomenclature}
  ...
  \begin{core}{Primary, Secondary, and Tertiary Alcohols}
    ...
    \myfig{0.65}{nomenclature_figures/pst_alcohols}{Primary, Secondary, and Tertiary Alcohols}{fig:pst_alcohols}
...
\section{Thiols}
  ...
  \begin{core}{Sulfur IUPAC Nomenclature}
    ...
    \myfig{0.4}{nomenclature_figures/sulfur_nomenclature1}{sulfer nomenclature 1}{fig:sulfur_nomenclature1}
    ...
    \myfig{0.6}{nomenclature_figures/sulfur_nomenclature2}{sulfer nomenclature 2}{fig:sulfur_nomenclature2}
...
\section{Isomer Configurations}

  \subsection{Cis \& Trans}
  ...
  \subsection{Absolute Configuration: The Gold Standard}

    \begin{core}{Absolute Configuration}

...
\section{Ether Synthesis}
  ...
  \begin{core}{Williamson Ether Synthesis}
    ...
    }{Williamson ether retrosynthesis; \textit{unsymmetrical ethers have two choices, one is usually favorable over the other}}{filler3}{0.8}
  ...
  \begin{core}{Alcoholysis of \ce{R_{sec/tert}X}}
    ...
    }{Alcoholysis of \ce{R_{sec/tert}X}}{fig:filler4}{0.8}
  ...
  \begin{core}{Intramolecular Williamson Ether Synthesis (\textit{Cyclic Ether Formation})}
    ...
    }{Intramolecular Williamson ether synthesis}{fig:filler5}{1.2}
    ...
    }{Backside attack and inversion in cyclic ether formation}{fig:filler6}{0.75}
    ...
    }{Relative rates of ring closure}{fig:filler7}{0.9}
  ...
  \begin{core}{Symmetrical Ether Synthesis via Alcohols}
    ...
    }{Symmetrical ether formation via \snt}{fig:filler8}{0.9}
    ...
    }{Symmetrical ether formation via \sno}{fig:filler9}{0.9}
...
\section{Ether Reactions}
  ...
  \begin{core}{\ce{R_{prim}-O-R_{prim}} Reaction}
    ...
    }{Ether cleavage with hydrohalic acids}{fig:filler11}{0.9}
  ...
  \begin{core}{\ce{R_{prim}-O-R_{sec}} Reaction}
    ...
    \reactionfig{
      \scheme{
        ...
        \arrow{->[\textcolor{Blue}{\ce{H+}, \ce{H2}}\textcolor{Red}{O}][\textit{Poor Nu}]}
        \chemfig{
          [:0,,,,Green]
          -[:30,,,,Black]
          (-[:90,,,,Black])
          -[@{bond}:-30]@{oxygen}\textcolor{Green}{\pcharge{-30}{O}}
          (-[:-90]\textcolor{Green}{H})
          -[:30]
          -[:-30]
        }
        ...
        \arrow{->[\textcolor{Blue}{\ce{H2}}\textcolor{Red}{O}][-\ce{H+}]}
        \chemfig{
          [:0]
          -[:60]
          (-[:0]\textcolor{Red}{O}H)
      ...
      \chemmovearrow{
        \reactionfigarrow{bond}{60}{oxygen}{90}{Red}
      }
    }{Mixed ether reaction with poor nucleophile (\sno)}{fig:filler13}{0.85}
  ...
  \begin{core}{t-Bu Ether Hydrolysis}
    ...
    \reactionfig{
      \scheme{
        ...
        \chemfig{
          [:0]\textcolor{Green}{R}
          -[:0,,,,Green]@{oxygen}\textcolor{Green}{\pcharge{-120}{O}}
          (-[:-60,,,,Green]\textcolor{Green}{H})
          -[@{bond}:60]
          (-[:150])
          (-[:-30])
      ...
      \chemmovearrow{
        \reactionfigarrow{bond}{-30}{oxygen}{-20}{Red}
      }
    }{Hydrolysis and deprotection of t-Butyl ethers}{fig:filler14}{0.85}
  ...
  \begin{core}{Ether Ring Opening}
    ...
    \reactionfig{
      \scheme{
        \chemfig{
          [:0]\textcolor{Red}{\ce{CH3O}}
          -[:60]\textcolor{Blue}{C}
          (<:[:100,,,,Blue]\textcolor{Blue}{H})
          (<[:170,,,,Blue]\textcolor{Blue}{H})
          -[:0]\textcolor{Green}{C}
          (<[:-80,,,,Green]\textcolor{Green}{\ce{CH3}})
          (<:[:-10,,,,Green]\textcolor{Green}{\ce{CH3}})
          -[:60]O\textcolor{Blue}{H}
        }
        \qquad
        \qquad
        \arrow{<-[\textcolor{Red}{\ce{CH3O-}}, \ce{CH3O}\textcolor{Blue}{H}][left carbon]}
        \qquad
        \chemfig{
          [:-150]*3(
          O
        ...
        \qquad
        \qquad
        \arrow{-/>[\textcolor{Red}{\ce{CH3O-}}, \ce{CH3O}\textcolor{Blue}{H}][right carbon]}
        \qquad
        \chemfig{
          [:0]\textcolor{Blue}{H}O
          -[:-60]\textcolor{Blue}{C}
          ...
          (<:[:80,,,,Green]\textcolor{Green}{\ce{CH3}})
          (<[:10,,,,Green]\textcolor{Green}{\ce{CH3}})
          -[:-60,,,,Red]\textcolor{Red}{\ce{OCH3}}
        }
      }
    }{Regioselective ether ring opening}{fig:filler15}{0.8}
    ...
    \reactionfig{
      \scheme{
        ...
        \arrow{->[
          \chemfig{
            @{rgroup}\textcolor{Red}{\ce{CH3}}Li
          }
        ][or \textcolor{Red}{\ce{CH3}}MgBr]}
        \qquad
        \chemfig{
          *6(--
          (<:[:-50]\textcolor{Red}{\ce{CH3}})
          (<[:10]H)
          -
          (<:[:-10]\ce{CH3})
          (<[:50]\textcolor{Green}{\ce{OH}})
          ---)
        }
      }
      \chemmovearrow{
        \reactionfigarrow{rgroup}{180}{carbon}{-100}{Red}
      }
    }{Stereocontrolled ether ring opening}{fig:filler16}{0.9}
    ...
    \reactionfig{
      \scheme{
        ...
        \qquad
        \quad
        \arrow{->[\ce{H+}][\textcolor{Red}{\textit{no rxn w/o \ce{H+}}}]}
        \chemfig{
          [:0]\ce{HO}
          -[:-30]
          -[:30]
    ...
    }{Acid-activated ether ring opening with neutral nucleophile}{fig:filler17}{1}
    ...
    }{Regioselectivity of acid-catalyed ring openign of asymmetrical ethers}{fig:filler18}{1.0}

  \end{core}

\section{Sulfur Analogs: \textit{A Brief Lesson}}

  \begin{core}{Sulfur Analogs}
  ...
  \begin{core}{Sulfur Reactivity}
    ...
    \doublereactionfig{
      ...
      \chemmovearrow{
        \reactionfigarrow{oxygen}{-90}{hydrogen}{0}{Red}
        \reactionfigarrow{bond1}{10}{bond2}{-10}{Red}
        \reactionfigarrow{bond3}{100}{leaving}{80}{Red}
      }
    }{
      \scheme{
        \chemfig{
      ...
      \chemmovearrow{
        \reactionfigarrow{sulfur}{-90}{carbon}{180}{Red}
        \reactionfigarrow{bond}{100}{leaving}{80}{Red}
      }
    }{Sulfur versus oxygen reaction with \ce{R_{sec}X}}{fig:filler19}{0.9}
    ...
    \doublereactionfig{
      ...
      \chemmovearrow{
        \reactionfigarrow{sulfur}{45}{rgroup}{90}{Red}
        \reactionfigarrow{bond}{100}{leaving}{80}{Red}
      }
    }{
      \scheme{
        \chemfig{
          \text{Good Leaving Group}
        }
        \qquad
        \chemfig{
          @{nuc}\textcolor{Red}{Nu}
      ...
      \chemmovearrow{
        \reactionfigarrow{nuc}{-100}{rgroup}{-80}{Red}
        \reactionfigarrow{bond}{-100}{sulfur}{-80}{Red}
      }
    }{Sulfide acting as a nucleophile to form a sulfonium ion (\textit{top}), which then acts as an alkylating agent toward an incoming nucleophile (\textit{bottom})}{fig:filler20}{0.9}

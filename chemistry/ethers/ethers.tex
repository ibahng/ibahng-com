...
\section{Ether Synthesis}
  ...
  \begin{core}{Ethers}
    ...
    }{Dimethyl ether structure}{filler1}{1.3}
  ...
  \begin{core}{Williamson Ether Synthesis}
    ...
    }{Williamson ether syntehsis retrosynthesis; \textit{unsymmetrical ethers have two retrosynthetic choices, one is usually favorable over the other}}{filler3}{0.8}
  ...
  \begin{core}{Symmetrical Ether Synthesis via Alcohols}
    ...
    }{Symmetrical ether formation via \sno}{fig:filler9}{0.95}

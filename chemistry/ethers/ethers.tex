...
\section{Ether Synthesis}
  ...
  \begin{core}{Ethers}
    ...
    }{Dimethyl ether structure}{filler1}{1.4}
  ...
  \begin{core}{Williamson Ether Synthesis}
    ...
    }{Williamson ether syntehsis retrosynthesis; \textit{unsymmetrical ethers have two retrosynthetic choices, one is usually favorable over the other}}{filler3}{1.1}
  ...
  \begin{core}{Intramolecular Williamson Ether Synthesis (Cyclic Ether Formation)}
    ...
    }{Intramolecular Williamson ether synthesis}{fig:filler5}{1.0}
...
\section{Ether Reactions}
  ...
  \begin{core}{\ce{R_{prim}-O-R_{sec}} Reaction}
    ...
    }{Mixed ether reaction with poor nucleophile (\sno)}{fig:filler13}{0.8}
  ...
  \begin{core}{t-Bu Ether Hydrolysis}
    ...
    }{Hydrolysis and deprotection of t-Butyl ethers}{fig:filler14}{0.8}
  ...
  \begin{core}{Ether Ring Opening}
    ...
    }{Stereocontrolled ether ring opening}{fig:filler16}{0.8}

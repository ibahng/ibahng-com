...
\section{Reaction Rate \& Equilibrium}
  ...
  If we start with a pure HA solution, the solution will gradually change color from \textcolor{Yellow}{yellow} to \textcolor{Green}{green} to \textcolor{Blue}{blue} as the forward reaction proceeds and [\ce{A^-}] rises. This particular compound is also known as an indicator, a concept covered in \autoref{acids-def:indicator}.

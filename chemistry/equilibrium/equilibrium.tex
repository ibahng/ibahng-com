...
\label{sec:shifting_eq}
  ...
  Temperature shifts have a more nuanced effect in the context of equilibrium compared to the simple Le Chatelier's principle we have seen in core concept \ref{core:letemp}. Namely, the $K_{sp}$ values of various solutes change across temperature ranges.

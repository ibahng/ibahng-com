...
\section{Rotamers}
  ...
  \begin{core}{Rotamer Example (\textit{Ethane})}
  ...
  \begin{core}{Stereoisometic Nomenclature (\textit{A Brief Aside})}
...
\section{Cycloalkane \& Ring Strain}
  ...
  \begin{core}{Cycloalkane Ring Strain}
    ...
    \begin{enumerate}[label=(\arabic*)]
      ...
      \item \textbf{Bond angle strain} (\textit{especially for smaller rings})

      \myfig{0.5}{conformational_analysis_figures/cycloalkane_bond_angles}{caption}{fig:fig6}

      \item \textbf{Eclipsing strain} (\textit{as we have discussed in 1.2.1 Rotamers})

      \item \textbf{Transannular strain} (\textit{the steric hinderence that occurs from atoms "bumping into each other" across the empty space in the middle of the ring})
  ...
  \begin{core}{Monosubstituted Cyclohexane}
